...
public class Customer{
  ...
  public Customer(String customerName, String customerAddress, String email, int amountBought, int customerID){
  ...
  public String toString()
	{
		return this.getCID()+";"+this.customerName +";"+this.customerAddress+";"+this.email;
	}
}